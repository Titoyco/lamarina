<x-app-layout>
    <h1 class="text-2xl font-bold mb-4">Crear Sucursal</h1>
    ...
    <form action="{{ route('sucursales.store') }}" method="POST" class="space-y-4 max-w-md">
        @csrf
        <div>
        ...
        <div>
            ...
            <small class="text-gray-600">Ejemplo: A, B, C</small>
        </div>
