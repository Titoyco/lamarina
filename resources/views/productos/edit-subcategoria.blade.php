...
<x-app-layout :botones="$botones">
    <div class="container mx-auto p-6">
        ...
        <h1 class="text-3xl font-semibold text-gray-800 mb-6">Editar Subcategoría</h1>
        ...
        <form action="{{ route('subcategorias.update', $subcategoria->id) }}" method="POST">
            ...
            <input type="text" name="nombre" id="nombre" value="{{ $subcategoria->nombre }}" class="mt-1 block w-full border border-gray-300 rounded py-2 px-3" required>
