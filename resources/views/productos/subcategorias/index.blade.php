...
<x-app-layout :botones="$botones">
    <div class="container mx-auto p-6">
        ...
        <a href="{{ route('productos.subcategorias.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded shadow hover:bg-blue-600">
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2">
                        <div class="flex space-x-2">
                            <a href="{{ route('productos.subcategorias.edit', $subcategoria->id) }}" class="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600">
                                Editar
                            </a>
                            <form action="{{ route('productos.subcategorias.destroy', $subcategoria->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar esta subcategoría?');">
                                @csrf
                                @method('DELETE')
